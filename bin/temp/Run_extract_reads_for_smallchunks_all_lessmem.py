...
def Run_extract_reads_for_smallchunks_all(out_dir,phase_cut_folder,cut_threshold,h5_folder,sample_name,fastq_folder,chr_start,chr_end,num_threads,read_type):
    count = 1
    ...
    for key, val in run_list.items():
        ...
        for chr_num in val:
            ...
            Extract_start(output_dir,chr_num,phased_h5_file,PS_flag_dict_cut_file,mole_qname_dict_file,qname_pos_dict_file,chr_fastq,read_type)
        """
        pool.close()
...
if __name__ == "__main__":
    ...
    Run_extract_reads_for_smallchunks_all(out_dir,phase_cut_folder,cut_threshold,h5_folder,sample_name,fastq_folder,chr_start,chr_end,num_threads,read_type)
