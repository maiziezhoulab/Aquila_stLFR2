...
import time
from Concatenate_contigs_all_v4_extend_for_HCbk_og import *
...
def use_spades(one_file_fastq,out_dir,read_type):
    if read_type == 'PE':
        rt_flag = '--12'
    else:
        rt_flag = '-s'
...
if __name__ == "__main__":
    ...
    run_spades_all(chr_start,chr_end,output_dir,num_of_threads,minicontig_dir,read_type)
